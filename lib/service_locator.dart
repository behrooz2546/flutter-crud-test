...
Future<void> init() async {
  sl.registerLazySingleton<CustomerListBloc>(() => CustomerListBloc(sl()));
  ...
  sl.registerLazySingleton<CreateCustomerRepository>(
      () => CustomerRepositoryImpl(sl()));
  sl.registerLazySingleton<UpdateCustomerRepository>(
      () => CustomerRepositoryImpl(sl()));
  sl.registerLazySingleton<DeleteCustomerRepository>(
      () => CustomerRepositoryImpl(sl()));
